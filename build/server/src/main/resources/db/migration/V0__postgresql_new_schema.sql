...
create table _creatable(_id int8 not null, _save_status int4, _name varchar(255), _ref_id int8, _child_id int8, _file_id varchar(255), _emb_name varchar(255), _is_basic bool, primary key (_id));
...
create table _creatables_request(_id int8 not null, _save_status int4, primary key (_id));
