...
public class CustomersSubscriptionHelper implements FlowableOnSubscribe<DataQueryDataChange> {
  ...
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = customersImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = customersImpl.getNativeResult();
