  ...
  Widget build(BuildContext context) {
        ...
        child: Stack(key: Key(isActive.toString()), children: [
          ...
          Align(
              ...
              child: EditableText(
                  ...
                  selectionColor: HexColor.fromHex('14acff'),
                  ...
                  cursorColor: this.cursorColor != null
                      ? this.cursorColor
                      : HexColor.fromHex('14acff'),
                  backgroundCursorColor: HexColor.fromHex('FF999999'),
    ...
    child = RepaintBoundary(
        child: Container(
            ...
            padding: InputFieldHelper.getPaddingInfo(this.dense),
