...
public class CustomersChangeTracker implements Cancellable {
  private Customers root;
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private Field field;

  public CustomersChangeTracker(
  ...
  public void init(OutObject out, Customers initialData) {
    {
  ...
  private void storeInitialData(Customers initialData) {
