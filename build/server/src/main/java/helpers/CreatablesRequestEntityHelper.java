...
@Service("CreatablesRequest")
public class CreatablesRequestEntityHelper<T extends CreatablesRequest> implements EntityHelper<T> {
  ...
  public CreatablesRequest newInstance() {
