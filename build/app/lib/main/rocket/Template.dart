...
class UsageConstants {
  static final int ACTIONUTIL_CHECKCREATABLE_QUERY_LOADCREATABLE = 0;
  static final int ACTIONUTIL_CHECKDELETE_QUERY_LOADCREATABLE = 1;
}
...
class Template {
  static String HASH = '80f367850489ec4b7882ee4c79f0682d';
  static List<Usage> _usages = [
    Usage(
        'ActionUtil_checkCreatable_Query_loadCreatable',
        [
          TypeUsage(CREATABLE, [
            FieldUsage(0, [
    ...
    Usage(
        'ActionUtil_checkDelete_Query_loadCreatable',
        [
          TypeUsage(CREATABLE, [
            FieldUsage(0, [
              TypeUsage(NONCREATABLE, [
