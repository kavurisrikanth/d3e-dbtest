...
public class ModelSchema1 {
  ...
  private void addCreatableFields() {
    DModel<Creatable> m = getType2("Creatable");
    m.addPrimitive(
        "name",
        Creatable._NAME,
        "_name",
    ...
    m.addReference(
        ...
        "_child_id",
        true,
        getType("NonCreatable"),
        (s) -> s.getChild(),
        (s, v) -> s.setChild(v));
    m.addReferenceCollection(
        "childColl",
        Creatable._CHILDCOLL,
        "_child_coll_id",
        "_creatable_child_coll",
        true,
        getType("NonCreatable"),
        (s) -> s.getChildColl(),
  ...
  private void addEmbeddedFields() {
    DModel<Embedded> m = getType2("Embedded");
    m.addPrimitive(
        "embName",
        Embedded._EMBNAME,
        "_emb_name",
  ...
  private void addNonCreatableFields() {
    DModel<NonCreatable> m = getType2("NonCreatable");
    m.addPrimitive(
        "name",
        NonCreatable._NAME,
        "_name",
